  ...
  <div class="container-flex">
    <nav class="navbar navbar-light">
      <div class="dropdown d-xl-none d-lg-none mr-auto">
        <img src="@/assets/hamburger-button-menu.png" width="32" height="32" data-toggle="dropdown" data-target="#navd" aria-haspopup="true" aria-expanded="false">
      ...
      <span class="navbar-item bc d-none d-xl-block d-lg-block py-0">
        ...
        <router-link class="px-5" to="/books">Books</router-link>
