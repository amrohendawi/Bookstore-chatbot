<template>
  <div>
    <div class="row mb-5" v-for="it in information" :key="it.isbn">
      <div class="col6 col-xl-6 col-lg-6 col-md-12 col-sm-12">
        <img class="img-fluid" :src="it.coverImg">
      </div>
      ...
      <div class="col6 col-xl-6 col-lg-6 col-md-12 col-sm-12 d-flex align-items-center justify-content-start">
        <div class="info pt-xl-0 pt-lg-0 pt-5">
          <span class="float-left pr-3">{{starsDict[Math.floor(it.rating) + 1]}}</span><h6 style="width:190px;">{{Math.floor(it.rating) + 1}} reviews</h6>
          ...
          <button class="add-to-cart-button" @click="addtoCart(it, it.isbn)">ADD TO CART</button>
        </div>
      </div>
    </div>
  </div>
