    ...
    <div :class="cClass">
        <div class="cart-menu">
            ...
            <transition-group name="fade">
                <div class="row" v-for="thing in cartContent" v-bind:key="thing.isbn">
                    <div class="col4 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                        <img :src="thing.coverImg" style="width: 90px;">
                    </div>
                    ...
                    <div class="col2 col-xl-2 col-lg-2 col-md-2 col-sm-2 pt-4">
                        <span class="remove-btn" @click="removeThing(thing.isbn)">remove</span>
                    </div>
                </div>
            </transition-group>
            ...
            <div class="col-md-12 text-center">
                  <router-link v-if="this.$store.state.cartItems.length>0"  to="/orderprocess"><button type="button" class="btn btn-success">Bestellung abschließen</button> </router-link>
            </div>
        </div>
    </div>
